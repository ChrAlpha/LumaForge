      ...
      >
        {({ openFilePicker, disabled }) => (
          <>
            ...
            {showSplit && (
              <>
                <span className="raw-lab-compare-label pointer-events-none absolute bottom-[calc(var(--raw-compare-track-bottom,0px)+18px)] left-[18px] z-[7] max-w-[calc(50%-32px)] rounded-full border border-[var(--color-stage-hairline)] bg-[var(--color-stage-panel)] px-2.5 py-1.5 text-xs font-medium leading-tight text-[var(--color-on-stage)] transition-opacity duration-[180ms] ease-[cubic-bezier(0.22,1,0.36,1)] max-[640px]:max-w-[calc(50%-22px)]">
                  {t('raw.stage.leftLabel')}
                </span>
                <span className="raw-lab-compare-label absolute bottom-[calc(var(--raw-compare-track-bottom,0px)+18px)] right-[18px] left-auto z-[7] max-w-[calc(50%-32px)] rounded-full border border-[var(--color-stage-hairline)] bg-[var(--color-stage-panel)] px-2.5 py-1.5 pointer-events-none text-xs font-medium leading-tight text-[var(--color-on-stage)] transition-opacity duration-[180ms] ease-[cubic-bezier(0.22,1,0.36,1)] max-[640px]:max-w-[calc(50%-22px)]">
